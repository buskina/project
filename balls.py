...
class Planets(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.k0 = randint(2, 6)
        pl0_img = pygame.image.load(
            path.join(img_dir, "pl"+str(self.k0)+".png")).convert()
        self.image = pl0_img
    ...
    def hit(self, obj):
        ...
        if (obj.rect.centerx-self.rect.centerx)**2 + (obj.rect.centery-self.rect.centery)**2 < (self.r+obj.r)**2:
            ...
            pl1_img = pygame.image.load(
                path.join(img_dir, "pl1.png")).convert()
...
class Exit0(pygame.sprite.Sprite):
    def __init__(self, screen):
        ...
        exit_img = pygame.image.load(
            path.join(img_dir, "портал.png")).convert()
